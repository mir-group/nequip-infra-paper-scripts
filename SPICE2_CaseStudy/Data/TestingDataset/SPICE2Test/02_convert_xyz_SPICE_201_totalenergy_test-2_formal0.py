...
for split in ["dimers"]:
    infile = h5py.File(
        f"/lustre/orion/mat281/proj-shared/24_11_04_BigData/SPICE-2/Revise-TotalEnergy/01_CreateDataset/SegmentedTest/SPICE-test-2-processed_charges_fullprecision_totalenergy_{split}.hdf5"
    )

    # Create the output file.
    filename = f"/lustre/orion/mat281/proj-shared/24_11_04_BigData/SPICE-2/Revise-TotalEnergy/01_CreateDataset/SegmentedTest/SPICE-test-2-processed_element-types_0-totalcharge_0-formalcharge_use-dfttotalenergy_units-eV-A_{split}.extxyz"
